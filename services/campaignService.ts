...
export const CAMPAIGN_BOSSES: CampaignBoss[] = [
  // Liga Pokémon - 8 Líderes de Ginásio
  {
    ...
    deck: ['074', '075', '076', '095', '111', '112', '027', '028', '104', '105', '050', '051', '129', '130', '142', '137', '031', '034', '083', '115'],
    hp: 8000,
  ...
  },
  {
    ...
    deck: ['025', '026', '100', '101', '081', '082', '125', '135', '145', '130', '131', '137', '132', '083', '016', '021', '133', '100', '101', '137'],
    hp: 9000,
  ...
  },
  {
    ...
    deck: ['001', '002', '003', '043', '044', '045', '069', '070', '071', '114', '102', '103', '124', '115', '127', '128', '133', '137', '054', '116'],
    hp: 9000,
    reward: { coins: 300, packs: 1 },
    unlocked: false,
    defeated: false,
  ...
  },
  {
    ...
    deck: ['023', '024', '041', '042', '088', '089', '109', '110', '015', '049', '029', '030', '031', '034', '092', '093', '094', '058', '059', '137'],
    hp: 9500,
  ...
  },
  {
    ...
    deck: ['063', '064', '065', '096', '097', '122', '124', '150', '132', '137', '138', '139', '144', '145', '146', '065', '122', '124', '133', '151'],
    hp: 10000,
  ...
  },
  {
    ...
    deck: ['004', '005', '006', '037', '038', '058', '059', '077', '078', '126', '146', '125', '130', '127', '133', '136', '059', '126', '015', '143'],
    hp: 10000,
    reward: { coins: 400, packs: 2 },
    unlocked: false,
    defeated: false,
  ...
  },
  {
    ...
    deck: ['050', '051', '074', '075', '076', '111', '112', '095', '031', '034', '027', '028', '104', '105', '129', '130', '083', '115', '137', '142'],
    hp: 10500,
  ...
  },
  {
    ...
    deck: ['147', '148', '149', '149', '130', '142', '006', '150', '149', '131', '133', '137', '143', '144', '145', '146', '129', '128', '127', '130'],
    hp: 12000,
  ...
  // Champion
  {
    ...
    deck: ['018', '059', '065', '103', '130', '112', '149', '150', '151', '131', '143', '129', '133', '137', '146', '144', '145', '125', '126', '127'],
    hp: 14000,
  ...
  // Bonus Bosses
  {
    ...
    deck: ['150', '150', '065', '094', '151', '149', '144', '145', '146', '137', '133', '139', '131', '130', '143', '132', '138', '151', '150', '149'],
    hp: 17000,
  ...
  },
  {
    ...
    deck: ['147','148','149','149','130','142','150','149','149','131','143','137','126','125','144','145','146','129','133','151'],
    hp: 16000,
